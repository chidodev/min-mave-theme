...
function dimox_breadcrumbs() {
    ...
    $text['tag']      = 'Posts with tags "%s"'; // текст для страницы тега
    $text['author']   = 'Posts from author %s'; // текст для страницы автора
    $text['404']      = 'Page 404'; // текст для страницы 404
    $text['page']     = 'Page %s'; // текст 'Страница N'
    $text['cpage']    = 'Comments page %s'; // текст 'Страница комментариев N'

    $wrap_before    = '<div class="row">
            <div class="col-md-8 offset-xl-2"><div class="breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList">'; // открывающий тег обертки
    $wrap_after     = '</div></div></div><!-- .breadcrumbs -->'; // закрывающий тег обертки
