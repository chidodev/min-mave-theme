...
if ( ! class_exists( 'True_Walker_Mobile_Nav_Menu' ) ) :

class True_Walker_Mobile_Nav_Menu extends Walker_Nav_Menu {
    /*
    ...
    function start_lvl(&$output, $depth = 0, $args = array()) {
        ...
        $output .= '<div class="navigation__submenu ">
...
//        }
        ...
        $item_output .= '</a>';
        $item_output .= '<span class="navigation__submenu-mobile">
