            ...
            <div class="col d-flex flex-column flex-lg-row">
                <div class="content">
                    ...
                    <div class="main-article">
                        <div class="baby-alphabet disease">
                            <!--                            <h3 class="main-article__title">< ?php if( is_category() ) echo get_queried_object()->name; ?></h3>-->
                            <div class="main-article__info custom-item-container d-flex flex-column d-lg-block clearfix">
                    ...
                    $top_5 = get_field('top_5', $term);
                    $topimage = get_field('topimage', $term);
                    if ($top_5) :
                        echo '<div class="d-flex justify-content-between disease-double-categorys">
                                    <div class="d-flex flex-column category-section custom-item-container disease-list-category">
                                        <h3 class="main-article__title disease-list-title">'.$top_5['title'].'</h3>
                                        <div class="d-flex flex-column disease-list">';
                        foreach ($top_5['top_5_items'] as $one) :
                            echo '<a title="'.$one['text'].'" href="'.$one['link'].'"><span>'.$one['text'].'</span></a>';
                        endforeach;
                        echo '</div>
                                </div>
    
                                <div class="category-section disease-picture-category custom-item-container">
                                    <div class="disease__section-picture">
                                        <a href="'.$topimage['link'].'">
                                            <img src="'.$topimage['image'].'" alt="'.$topimage['text'].'">
                                        </a>
                                    </div>
    
                                    <h3 class="main-article__title"><a href="/baby-leksikon">'.$topimage['text'].'</a></h3>
                                </div>
                            </div>';

                    endif;?>
                    <div class="baby-alphabet__title">
                        Sygdomme
                    </div>
                    ...
                    <div class="articles">
                        <div class="last-articles__title">
                            Artikler - Sygdomme og sundhed – Baby + små børn
                        </div>
