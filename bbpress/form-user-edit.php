	...
	<fieldset class="bbp-form">
        ...
        <div class="custom-checkbox-block">
            <label for="bbpm_notify">
                <input type="checkbox" name="bbpm_notify" id="bbpm_notify" <?php checked(get_user_meta(bbp_get_displayed_user_id(), 'bbpm_mute_notifications', true), false); ?> />
...
<!--					<label for="super_admin">--><?php //esc_html_e( 'Network Role', 'bbpress' ); ?><!--</label>-->
	...
	<fieldset class="submit">
		...
		<div>
			...
			<button class="custom-btn" type="submit" id="bbp_user_edit_submit" name="bbp_user_edit_submit" class="button submit user-submit"><?php bbp_is_user_home_edit()
