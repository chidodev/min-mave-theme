...
<?php if ( bbp_current_user_can_access_create_reply_form() ) : ?>
	...
	<div id="new-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-form custom-item-container">
		...
		<form id="new-post" name="new-post" method="post">
			...
			<div class="bbp-form">
				<legend><?php printf( esc_html__( 'Dit svar: %s', 'bbpress' ), ( bbp_get_form_reply_to() ) ? sprintf( esc_html__( 'Reply #%1$s in %2$s', 'bbpress' ), bbp_get_form_reply_to(), bbp_get_topic_title() ) : bbp_get_topic_title() ); ?></legend>
...
<!--						</p>-->
					...
					<div class="submit-block d-flex align-items-center flex-column flex-lg-row">
                        ...
                        <div class="bbp-submit-wrapper d-flex align-items-center">

                            <?php do_action( 'bbp_theme_before_reply_form_submit_button' ); ?>

                            <?php bbp_cancel_reply_to_link(); ?>

                            <button type="submit" id="bbp_reply_submit" name="bbp_reply_submit" class="custom-btn submit">Send dit svar</button>
