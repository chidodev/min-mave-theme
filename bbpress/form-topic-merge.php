		...
		<div id="merge-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-merge">
			...
			<form id="merge_topic" name="merge_topic" method="post">
				...
				<fieldset class="bbp-form">
                  ...
                  <div class="custom-checkbox-block d-flex align-items-center">
                    <label for="bbp_topic_subscribers">
                      ...
                      <div class="form-check-label"><?php esc_html_e( 'Merge topic subscribers', 'bbpress' ); ?></div>
                    </label>
                  </div>
                ...
                <div class="custom-checkbox-block d-flex align-items-center">
                  <label for="bbp_topic_favoriters">
                    ...
                    <span class="checkmark"></span>
                    <div class="form-check-label"><?php esc_html_e( 'Merge topic favoriters', 'bbpress' ); ?></div>
                  </label>
                </div>
                  ...
                  <div class="custom-checkbox-block d-flex align-items-center">
                    <label for="bbp_topic_tags">
                      ...
                      <span class="checkmark"></span>
                      <div class="form-check-label"><?php esc_html_e( 'Merge topic tags', 'bbpress' ); ?></div>
                    </label>
                  </div>
