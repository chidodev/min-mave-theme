...
//require( ABSPATH . 'wp-load.php' );		//nsur removed
//require( ABSPATH . 'wp-load.php' );		//nsur removed

//add_action( 'wp_head', 'wp_no_robots' );  //nsur removed

//require_once( ABSPATH . 'wp-blog-header.php' );	//nsur removed
            ...
            function show_user_form( $user_name = '', $user_email = '', $errors = '' ) {
                ...
                <div class="login__inputs-block">
                    <div class="d-flex align-items-center justify-content-between login-row">
                        <span class="d-none d-md-block form-label login-label">' . __( 'Username:' ) . '</span>';
                $errmsg = $errors->get_error_message( 'user_name' );
                        echo '<div class="custom-input">
                            <label for="user_name">' . __( 'Username:' ) . '</label>';

                            echo '<input name="user_name" type="text" id="user_name" class="required login-form-input" type="text" value="' . esc_attr( $user_name ) . '" autocapitalize="none" autocorrect="off" maxlength="60" /><br />';
                    ...
                    <div class="d-flex align-items-center justify-content-between login-row">
                        ...
                        <div class="custom-input">'; ?>
                            ...
                            <input name="user_email" type="text" id="user_email" class="required login-form-input email-input" value="<?php echo esc_attr( $user_email ); ?>" maxlength="200" class="required login-form-input email-input"  />
                <?php
                ...
                <div class="register__checkboxes-block">
                    ...
                    <div class="custom-checkbox-block d-flex align-items-start form-check mailing-check">
                        <label>
                            <input type="checkbox" name="submit-agree">
                            <span class="checkmark"></span>
    ...
    <div class="login__page d-flex">
        <div class="container">
            ...
            <div class="login-block">
                <form id="setupform" method="post" action="" class="login__form validate" novalidate="novalidate"><!-- nsur plugin drops the action="wp-signup.php" -->
...
<!--                    <p class="submit"><input type="submit" name="submit" class="submit" value="--><?php //esc_attr_e( 'Next' ); ?><!--" /></p>-->
            ...
            function confirm_user_signup( $user_name, $user_email ) {
                ...
                <div class="login__page d-flex">
                    <div class="container">
                        ...
                        <div class="login-block register-success-form">
                            <form class="login__form validate" method="post" action="">
                ...
                <p><?php _e( 'If you do not activate your username within two days, you will have to sign up again.' ); ?> Hvis du ikke finder verificerings-e-mailen i din indbakke, så prøv at se i dine andre mapper som fx Spam/Reklame eller Promoveret.</p>
            ...
            if ( current_user_can( 'manage_network' ) ) {
                ...
                //nsur changed from printf( __( 'To change or disable registration go to your <a href="%s">Network Options page</a>.' ), esc_url( network_admin_url( 'settings.php' ) ) );
            ...
            if ( 'none' === $active_signup ) {
                ...
                switch ( $stage ) {
                    ...
                    case 'validate-blog-signup':
                        if ( 'user' === $active_signup || 'blog' === $active_signup ) {
