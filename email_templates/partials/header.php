...
<!--		    --><?//= $settings['custom_css'];?>
    ...
    <table cellspacing="0" cellpadding="0" border="0" class="content" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0px 6px 0px 0px #634282; font-family: 'Quicksand', sans-serif; margin: auto; max-width: 415px; padding: 30px 40px;">
        <tr>
            <td>
                <a style="" href="<?php echo apply_filters( 'mailtpl/templates/header_logo_url', home_url());?>" title="<?php echo apply_filters( 'mailtpl/templates/header_logo_url_title', !empty($settings['header_logo_text']) ? do_shortcode( strip_tags($settings['header_logo_text']) ) : get_bloginfo('name') );?>"><?php
                    if( !empty($settings['header_logo']) ) {
                        ...
                        echo '<img '.implode(' ', $header_logo_attr).' src="'.apply_filters( 'mailtpl/templates/header_logo', $settings['header_logo'] ).'" width="77" height="36" alt="'. apply_filters( 'mailtpl/templates/header_logo_alt', !empty($settings['header_logo_text']) ? do_shortcode( strip_tags($settings['header_logo_text']) ) : get_bloginfo( 'description' ) ) .'"/>';
